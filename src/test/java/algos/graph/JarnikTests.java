...
import algos.graph.specialized.CityWeightedIncidentalityListGraph;
...
public class JarnikTests {
    ...
    @Test
    public void jarnickWeightedIncidentalityListGraphTest() {

        WeightedIncidentalityListGraph graph =
                new WeightedIncidentalityListGraph<String, WeightedRib>(
                        new ArrayList<>(List.of("A", "B", "C", "D", "E", "F", "J", "K", "Y")));
    ...
    @Test
    public void jarnickCityWeightedIncidentalityListGraphTest() throws GraphInstantiationException {
        City[] arr = City.values();

        CityWeightedIncidentalityListGraph<CityNode, WeightedRib> graph =
                new CityWeightedIncidentalityListGraph<>(Arrays.stream(arr).map(CityNode::new).collect(Collectors.toCollection(ArrayList::new)));
    ...
    @Test
    public void jarnickCrossroadsWeightedIncidentalityListGraphTest() {
        Crossroad[] arr = Crossroad.values();
