...
public class AStarTests {
    ...
    public void aStarCrossroadsWeightedAdjacencyMatrixGraphTest() throws GraphInstantiationException {
        ...
        System.out.println("Adjacency matrix graph. Average A* path build time " + Arrays.stream(millis).average().getAsDouble() + " millis.");

    }

    @Test
    public void aStarCrossroadsWeightedIncidentalityListGraphTest() throws GraphInstantiationException {
        AtomicInteger stepsCounter = new AtomicInteger(0);
        ...
        System.out.println("Incidency list graph. Average A* path build time " + Arrays.stream(millis).average().getAsDouble() + " millis.");
