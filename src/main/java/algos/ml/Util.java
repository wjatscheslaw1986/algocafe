...
public final class Util {
	...
	/**
	 * This method returns a dot (scalar) product of two vectors described with their Cartesian coordinates.
	 * Both vecors are in the same-dimensional space (i.e. both vectors share same amount of Cartesian coordinates)
	 *
	 * @param xs - an array of Cartesian coordinates of the first factor-vector
	 * @param ys  - an array of Cartesian coordinates of the second factor-vector
	 * @return the floating point number which is the product of the dot product
	 */
