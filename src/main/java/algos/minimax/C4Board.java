...
public class C4Board implements Board<Integer> {
	...
	/**
	 * This method counts how many locations/pieces of the 'colour' this 'segment' contains
	 *
	 * @param segment a segment of 4 locations
	 * @param color a color
	 * @return number of locations of that particular colour in the segment
	 */
	...
	/**
	 * This method determines if there is a victory case, regardless of who has won
	 *
	 * @return 'true' if anyone has won, otherwise false
	 */
	@Override
